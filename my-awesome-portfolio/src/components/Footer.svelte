...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> kajtek.gdynia@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a
                href="https://github.com/KajetanFrackowiak"
                target="_blank"
                class="text-violet-400"
                >KajetanFrackowiak<sup class=""
        ...
        <p>
            ...
            <a
                href="https://www.linkedin.com/in/kajetan-fr%C4%85ckowiak-b5b69b1b8/"
                target="_blank"
                class="text-violet-400"
                >kajetan-frąckowiak<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
