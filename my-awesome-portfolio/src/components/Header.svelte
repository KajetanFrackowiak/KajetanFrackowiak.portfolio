...
>
    <h1 class="font-medium">
        <b class="font-bold poppins">Kajetan</b> <span class="">Frąckowiak</span>
    </h1>
    <div class="sm:flex items-center gap-4 hidden">
        ...
        <button class="blueShadow relative overflow-hidden px-5 py-2 group rounded-full bg-white text-slate-950" onclick="scrollToTop()">
